        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <motion.div
              ...
              onClick={() => navigate('/')}
            >
              <h1 className="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-fuchsia-500 bg-clip-text text-transparent">
                Sweet-Shop
              </h1>
            </motion.div>
            ...
            <div className="hidden md:flex items-center flex-1 max-w-md mx-8">
              <div className="relative w-full">
                ...
                <Input
                  ...
                  className="pl-10 bg-gray-50 dark:bg-gray-800 border-0 focus:ring-2 focus:ring-indigo-600"
                />
              </div>
            </div>
              ...
              {isAuthenticated ? (
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Button
                    ...
                    className="bg-gradient-to-r from-indigo-600 to-fuchsia-500 hover:from-indigo-700 hover:to-fuchsia-600 text-white"
                  >
                    Sign Up
                  </Button>
                </div>
